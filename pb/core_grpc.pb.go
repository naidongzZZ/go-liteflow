...
const (
	Core_EventChannel_FullMethodName         = "/pb.core/EventChannel"
	Core_DirectedEventChannel_FullMethodName = "/pb.core/DirectedEventChannel"
	Core_SendHeartBeat_FullMethodName        = "/pb.core/SendHeartBeat"
	Core_SubmitOpTask_FullMethodName         = "/pb.core/SubmitOpTask"
	Core_DeployOpTask_FullMethodName         = "/pb.core/DeployOpTask"
	Core_ManageOpTask_FullMethodName         = "/pb.core/ManageOpTask"
	Core_ReportOpTask_FullMethodName         = "/pb.core/ReportOpTask"
	Core_DownloadOpTaskEF_FullMethodName     = "/pb.core/DownloadOpTaskEF"
)
...
func (c *coreClient) EventChannel(ctx context.Context, opts ...grpc.CallOption) (Core_EventChannelClient, error) {
	stream, err := c.cc.NewStream(ctx, &Core_ServiceDesc.Streams[0], Core_EventChannel_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *coreClient) DirectedEventChannel(ctx context.Context, opts ...grpc.CallOption) (Core_DirectedEventChannelClient, error) {
	stream, err := c.cc.NewStream(ctx, &Core_ServiceDesc.Streams[1], Core_DirectedEventChannel_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *coreClient) SendHeartBeat(ctx context.Context, in *HeartBeatReq, opts ...grpc.CallOption) (*HeartBeatResp, error) {
	...
	err := c.cc.Invoke(ctx, Core_SendHeartBeat_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coreClient) ManageOpTask(ctx context.Context, in *ManageOpTaskReq, opts ...grpc.CallOption) (*ManageOpTaskResp, error) {
	...
	err := c.cc.Invoke(ctx, Core_ManageOpTask_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coreClient) DownloadOpTaskEF(ctx context.Context, in *DownloadReq, opts ...grpc.CallOption) (Core_DownloadOpTaskEFClient, error) {
	stream, err := c.cc.NewStream(ctx, &Core_ServiceDesc.Streams[2], Core_DownloadOpTaskEF_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func _Core_SendHeartBeat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Core_SendHeartBeat_FullMethodName,
	}
...
func _Core_ManageOpTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Core_ManageOpTask_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
